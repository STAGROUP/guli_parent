...
public class TestVod {
    public static void main(String[] args) throws Exception {
        //上传视频的方法
        String accessKeyId = "LTAI5tCVMLdNZYEPpazMztF3";
        String accessKeySecret = "qQCmgkaBOibXJog17smFiNY8Nfap2P";
        String title = "6 - What If I Want to Move Faster - upload by sdk";   //上传之后文件名称
        String fileName = "F:/学习资料/尚硅谷_谷粒学院/头像/6 - What If I Want to Move Faster.mp4";  //本地文件路径和名称
        //上传视频的方法
